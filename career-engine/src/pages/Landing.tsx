    ...
    <PageTransition>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="w-full py-24 md:py-32 lg:py-48 flex-1 flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/10 rounded-full blur-[120px] pointer-events-none -z-10 opacity-60" />
          <div className="absolute top-1/4 -right-1/4 w-[500px] h-[500px] bg-accent/15 rounded-full blur-[100px] pointer-events-none -z-10" />
          ...
          <div className="container px-4 md:px-6 max-w-5xl mx-auto flex flex-col items-center text-center space-y-10">
            ...
            >
              Discover Your Career Path with <span className="gradient-text">Brutal Honesty.</span>
            </motion.h1>
