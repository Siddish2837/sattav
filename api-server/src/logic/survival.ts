...
export function getStressFit(
  userStressTolerance: number,
  careerStressLevel: number,
) {
...
export function getWorkHoursFit(preferredHours: number, careerHours: number) {
...
export function getLearningCurveFit(
